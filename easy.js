...
async function easyMode(){        
            ...
            if (result){
                ...
                fss.readFile('score.json',(err,data)=>{
                    ...
                    jsondata.Easy??=[];
                    jsondata.Easy.push(scoreValue);
                    jsondata.Easy= jsondata.Easy.sort((a,b)=>a.guessCount-b.guessCount || a.timetaken-b.timetaken).slice(0,5); // sorts and keeps only top five score
                //Above line is similar to this
                    // jsondata.Easy.sort((a,b)=>{
