...
async function hardMode(){        
            ...
            if (result){
                ...
                fss.readFile('score.json',(err,data)=>{
                    ...
                    jsondata.Hard??=[];
                    jsondata.Hard.push(scoreValue);
                    jsondata.Hard= jsondata.Hard.sort((a,b)=>a.guessCount-b.guessCount || a.timetaken-b.timetaken).slice(0,5); // sorts and keeps only top five score
                //Above line is similar to this
                    // jsondata.Hard.sort((a,b)=>{
